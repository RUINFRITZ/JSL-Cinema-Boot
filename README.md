...
[![Presentation](https://img.shields.io/badge/Presentation-View_Slide-E67E22?style=for-the-badge&logo=google-chrome)](https://RUINFRITZ.github.io/JSL-Cinema-Boot/presentation.html) : **JSL人材開発院 Cloud連携Web開発者課程26期 個人プロジェクト II** 
...
| :--- | :--- | :--- | :--- |
| **Language** | Java | 17 | **[標準と安定性]** 不要なコードを削減して可読性を向上。 |
...
| **Template** | Thymeleaf | 3.1.3 | [SSRと保守性] 純粋なHTML構造を維持する「ナチュラルテンプレート」を採用し、Spring MVCとのシームレスな連携およびフロントエンドの保守性を最大化するため。 |
